...
<form method="POST" action="<?php echo e($isEdit ? route('admin.games.update', $game) : route('admin.games.store')); ?>" enctype="multipart/form-data" class="stack form-panel">
    <?php echo csrf_field(); ?>
    <?php if($isEdit): ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="card">
                <div class="card__body stack">
                    ...
                    <?php if($isEdit): ?>
                        <img class="cover cover--rounded" src="<?php echo e($game->coverUrl()); ?>" alt="Sampul <?php echo e($game->title); ?>">
                    <?php endif; ?>
                    <input class="input" type="file" name="cover" accept="image/jpeg,image/png,image/webp" aria-label="Gambar sampul" <?php if(! $isEdit): echo 'required'; endif; ?>>
...
<?php /**PATH /tmp/pp/src/pixelplay/resources/views/admin/games/form.blade.php ENDPATH**/ ?>